...
export function MapV2DisplayRenderer({ name, controlId, config, runtime, resources }: { name: string; controlId: string; config: MapV2DisplayConfig; runtime: RuntimeState; resources: Record<string, string> }) {
  ...
  return <div data-map-v2 data-control-root data-control-name={name} data-runtime-name={name} style={{ position: 'relative', width, height, overflow: 'hidden' }}>
