...
export function BorderedImageRenderer({ name, config, runtime, resources, behaviorSet }: { name: string; config: ImageConfig; runtime: RuntimeState; resources: Record<string, string>; behaviorSet?: ControlBehaviorSet }) {
  ...
  return <div className="web-bordered-image" data-outer-border data-control-root data-control-name={name} data-runtime-name={name} data-behavior-guid={config.BehaviorGuid} style={borderStyle}>
