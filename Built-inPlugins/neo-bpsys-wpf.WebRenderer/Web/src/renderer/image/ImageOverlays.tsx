...
export function ImageOverlays({ name, config, runtime, resources, defaultPickingBorderResourceUrl }: { name: string; config: ImageConfig; runtime: RuntimeState; resources: Record<string, string>; defaultPickingBorderResourceUrl?: string }) {
