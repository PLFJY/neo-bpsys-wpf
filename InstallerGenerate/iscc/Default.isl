...
; 如果可以的话，不要将“Compact”翻译为“Minimal”（我的意思是你的语言中的“Minimal（最小）”）
...
; *** TExtractionWizardPage 向导页面和 Extract7ZipArchive
...
; 下面的自定义消息不会被安装程序本身使用，但如果你在脚本中使用它们，
; 则需要对它们进行翻译。
