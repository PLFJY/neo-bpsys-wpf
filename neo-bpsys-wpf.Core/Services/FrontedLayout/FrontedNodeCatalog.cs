    ...
    private static IReadOnlyList<FrontedNodeTypeDescriptor> CreateNodes()
    {
        ...
        [
            ...
            Node("action.setProperty", "Action", [flowIn, ValueIn("ValueInput")], [flowOut],
                ...
                Prop("ValueInputUnit", FrontedNodePropertyType.Enum, "Absolute", FrontedNodePropertyEditorKind.Enum, false, numericInputUnitOptions)),
            ...
            Node("action.animateProperty", "Action", [flowIn, ValueIn("FromInput"), ValueIn("ToInput")], [flowOut],
                ...
                Prop("FromInputUnit", FrontedNodePropertyType.Enum, "Absolute", FrontedNodePropertyEditorKind.Enum, false, numericInputUnitOptions),
                Prop("ToInputUnit", FrontedNodePropertyType.Enum, "Absolute", FrontedNodePropertyEditorKind.Enum, false, numericInputUnitOptions)),
