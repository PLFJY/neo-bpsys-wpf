...
public partial class Game : ViewModelBase, IRecipient<MemberOnFieldChangedMessage>, IRecipient<NewGameMessage>
{
    ...
    [ObservableProperty] private Team _surTeam = new(Camp.Sur, TeamType.MainTeam);

    [ObservableProperty] private Team _hunTeam = new(Camp.Hun, TeamType.AwayTeam);
        ...
        Dictionary<string, MapV2>? mapV2Dictionary = null)
    {
        ...
        OnPropertyChanged(nameof(Core.Models.Game.SurTeam));
        OnPropertyChanged(nameof(Core.Models.Game.HunTeam));
    ...
    public void BanMap(List<BanMapInfo> mapList, Team? team = null)
    {
