...
public static class MessageBoxHelper
{
    ...
    public static async Task<bool> ShowDeleteConfirmAsync(string title, string message, string primaryButtonText = "Confirm",
    ...
    public static async Task<bool> ShowConfirmAsync(string title, string message, string primaryButtonText = "Confirm",
        string secondaryButtonText = "Cancel")
    {
        var messageBox = new MessageBox()
        {
